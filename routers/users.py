...
from schemas import PostResponse, UserCreate, UserPrivate, UserPublic, UserUpdate, Token, PaginatedPostsResponse, ForgotPasswordRequest, ResetPasswordRequest, ChangePasswordRequest
...
async def upload_profile_picture(
    ...
    if old_filename:
        await delete_profile_image(str(old_filename))
